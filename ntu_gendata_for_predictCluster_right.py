...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/home/pkapade_umass_edu/PCRP/nturgb+d_skeletons/')
    parser.add_argument(
        '--ignored_sample_path',
        default='/home/pkapade_umass_edu/PCRP/ntu60/NTU_RGBD_samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='/home/pkapade_umass_edu/PCRP/data/data_for_pytorch/ntu60_2person')
