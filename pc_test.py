...
def train():
    ...
    # random_seed = 11
    dataset = 'ucla' # ntu60, ntu120, ucla, uwa3d, sbu
    ...
    # global variable
    root = '/home/pkapade_umass_edu/PCRP/'
    dataset_root = root
#     if 'ntu' in dataset:
...
#         raise ValueError
    ...
    if 'ntu' in dataset:
        ...
        data_path_test = dataset_path + 'test.h5'
    ...
    if 'ntu' in dataset:
        ...
        pad_style = pad_collate_ntu
    elif 'ucla' in dataset: #changemade
...
#     path_best = '/home/pkapade_umass_edu/PCRP/ucla_view/model_biF_RevF_protpT_[150_180_210]_Rg60_denNone_batch64_epoch10_FW_seed77_LinEvalT/FWlayer3_hid1024_epoch10_trainLoss13.0485'
